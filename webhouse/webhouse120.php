    ...
    public function render_dashboard_page() {
        ...
        <div class="wrap">
            ...
            <ul style="list-style: disc; margin-left: 20px;">
                ...
                <li><strong><?php esc_html_e( 'Update Emails', 'webhouse' ); ?>:</strong> <?php esc_html_e( 'Customizes the recipient, subject, and sender details for automatic plugin/theme update notification emails.', 'webhouse' ); ?></li>
...
// =================================================================
// 3. Auto-Update Email Customization Module (NEW)
// =================================================================
...
class WebHOUSE_Module_Updates {
    ...
    public function __construct( $parent_slug ) {
        ...
        // Hook into the auto-update email filter (priority 999 to override others)
        add_filter( 'auto_plugin_theme_update_email', [ $this, 'customize_update_email' ], 999, 4 );
    }
    ...
    public function render_settings_page() {
        ...
        <div class="wrap">
            ...
            <p class="description"><?php esc_html_e( 'Use these settings to customize the recipient, subject, and sender information for the automated emails WordPress sends after plugins or themes successfully auto-update.', 'webhouse' ); ?></p>
            <hr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="<?php echo esc_attr( $this->option_name ); ?>[email_subject]"
                                ...
                                class="regular-text" />
                            <p class="description"><?php esc_html_e( 'Leave empty to use the default subject generated by WordPress.', 'webhouse' ); ?></p>
                        </td>
                    </tr>
                </table>
    ...
    /**
     * Customizes the auto-update email recipient and subject using saved options.
     * Hooked to 'auto_plugin_theme_update_email'.
     *
     * @param array $email The email array with 'to', 'subject', 'body', 'headers'.
     * @param string $type The type of update email (success, mixed, or fail).
     * @param array $successful_updates Array of successful update info.
     * @param array $failed_updates Array of failed update info.
     * @return array The filtered email array.
     */
    public function customize_update_email( $email, $type, $successful_updates, $failed_updates ) {
        $options = get_option( $this->option_name, [] );
        ...
        if ( ! empty( $custom_subject ) ) {
            // Use str_replace for common update placeholders if they exist

    ...
    public function render_dashboard_page() {
        ...
        <div class="wrap">
            ...
            <ul style="list-style: disc; margin-left: 20px;">
                ...
                <li><strong><?php esc_html_e( 'Update Emails', 'webhouse' ); ?>:</strong> <?php esc_html_e( 'Customizes the recipient, subject, and sender details for automatic core, plugin, and theme update notification emails.', 'webhouse' ); ?></li>
...
class WebHOUSE_Module_SMTP {
    ...
    public function render_settings_page() {
        ...
        ?>
        <div class="wrap">
            <h1><?php esc_html_e( 'WebHOUSE Gmail SMTP Settings', 'webhouse' ); ?> <small style="font-size:12px">v1.0.2</small></h1>
